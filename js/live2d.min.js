 ...
 * Original files:
 * - /gh/Dreamer-Paul/Pio@2.4/static/l2d.min.js
 * - /gh/Dreamer-Paul/Pio@2.4/static/pio.min.js
 *
...
var Paul_Pio = function (prop) {
        var current = {
                ...
                modules = {
                        idol: function () {
                                return current.idol < prop.model.length - 1 ? current.idol++ : current.idol = 0, current.idol
                        },
                        create: function (e, n) {
                                var o = document.createElement(e);
                                return n.class && (o.className = n.class), o
                        },
                        rand: function (e) {
                                return e[Math.floor(Math.random() * e.length + 1) - 1]
                        },
                        render: function (e) {
                                e.constructor === Array ? dialog.innerText = modules.rand(e) : e.constructor === String ? dialog.innerText = e : dialog.innerText = "输入内容出现问题了 X_X", dialog.classList.add("active"), clearTimeout(this.t), this.t = setTimeout(function () {
                                        dialog.classList.remove("active")
                                }, 3e3)
                        },
                        destroy: function () {
                                current.body.parentNode.removeChild(current.body), document.cookie = "posterGirl=false;path=/"
                        }
                },
                elements = {
        ...
        var action = {
                        welcome: function () {
                                if ("" !== document.referrer && -1 === document.referrer.indexOf(current.root)) {
                                        var e = document.createElement("a");
                                        e.href = document.referrer, prop.content.referer ? modules.render(prop.content.referer.replace(/%t/, "“" + e.hostname + "”")) : modules.render("欢迎来自 “" + e.hostname + "” 的朋友！")
                                } else if (prop.tips) {
                                        var n, o = (new Date).getHours();
                                        n = o > 22 || o <= 5 ? "你是夜猫子呀？这么晚还不睡觉，明天起的来嘛" : o > 5 && o <= 8 ? "早上好！" : o > 8 && o <= 11 ? "上午好！工作顺利嘛，不要久坐，多起来走动走动哦！" : o > 11 && o <= 14 ? "中午了，工作了一个上午，现在是午餐时间！" : o > 14 && o <= 17 ? "午后很容易犯困呢，今天的运动目标完成了吗？" : o > 17 && o <= 19 ? "傍晚了！窗外夕阳的景色很美丽呢，最美不过夕阳红~" : o > 19 && o <= 21 ? "晚上好，今天过得怎么样？" : o > 21 && o <= 23 ? "已经这么晚了呀，早点休息吧，晚安~" : "奇趣保罗说：这个是无法被触发的吧，哈哈", modules.render(n)
                        ...
                        buttons: function () {
                                ...
                                }, current.menu.appendChild(elements.home), elements.skin.onclick = function () {
                                        loadlive2d("pio", prop.model[modules.idol()]), prop.content.skin && prop.content.skin[1] ? modules.render(prop.content.skin[1]) : modules.render("新衣服真漂亮~")
                                }, elements.skin.onmouseover = function () {
                                        prop.content.skin && prop.content.skin[0] ? modules.render(prop.content.skin[0]) : modules.render("想看看我的新衣服吗？")
                                }, prop.model.length > 1 && current.menu.appendChild(elements.skin), elements.info.onclick = function () {
                                        window.open(prop.content.link || "https://paugram.com/coding/add-poster-girl-with-plugin.html")
                                }, elements.info.onmouseover = function () {
                                        modules.render("想了解更多关于我的信息吗？")
                                }, current.menu.appendChild(elements.info), prop.night && (elements.night.onclick = function () {
                                        eval(prop.night)
                                }, elements.night.onmouseover = function () {
                                        modules.render("夜间点击这里可以保护眼睛呢")
                                }, current.menu.appendChild(elements.night)), elements.close.onclick = function () {
                                        modules.destroy()
                        ...
                        custom: function () {
                                prop.content.custom.forEach(function (e) {
                                        ...
                                        if (n.length)
                                                for (var o = 0; o < n.length; o++) "read" === e.type ? n[o].onmouseover = function () {
                ...
                begin = {
                        ...
                        draggable: function () {
                                ...
                                e.onmousedown = function () {
                                        ...
                                        function o(o) {
                                                e.classList.add("active"), e.classList.remove("right"), e.style.left = event.clientX - n.x + "px", e.style.top = event.clientY - n.y + "px"
                                        }
                                        document.addEventListener("mousemove", o), document.addEventListener("mouseup", function () {
                                                e.classList.remove("active"), document.removeEventListener("mousemove", o)
                                        })
                                }
                        }
                };
        this.init = function () {
                if (!0 === prop.hidden && window.innerWidth < 400) current.body.classList.add("hidden");
                        ...
                        prop.content.custom && action.custom(), loadlive2d("pio", prop.model[0])
                }
        }, this.init()
};
...
//# sourceMappingURL=/sm/142e78b9f2b6caf9349397a4079db48feed1e33804c8779ea3f3ab97f07c736c.map
