...
var Paul_Pio = function (prop) {
  ...
  const elements = {
    home: tools.create("span", {
      class: "pio-home"
    }),
    skin: tools.create("span", {
      class: "pio-skin"
    }),
    info: tools.create("span", {
      class: "pio-info"
    }),
    night: tools.create("span", {
      class: "pio-night"
    }),
    close: tools.create("span", {
      class: "pio-close"
    }),

    dialog: tools.create("div", {
      class: "pio-dialog"
    }),
    show: tools.create("div", {
      class: "pio-show"
    })
  };
  ...
  const action = {
    ...
    buttons: () => {
      ...
      elements.info.onclick = () => {
        window.open(prop.content.link || "#about-railgun");
      };
